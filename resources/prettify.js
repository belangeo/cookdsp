...
(function () {
  ...
  var COOKDSP_KEYWORDS = ["memalloc," +
      ...
      "scale,list,set,tmp,sumchnls,buffer,buffer_init,buffer_write," +
      "buffer_read,buffer_fread,buffer_nread,buffer_fnread,buffer_read2,buffer_fread2,buffer_nread2,buffer_fnread2," +
      "buffer_read3,buffer_fread3,buffer_nread3,buffer_fnread3,buffer_lookup,buffer_lookup2,buffer_lookup3,buffer_gen10," +
      "buffer_saw,buffer_square,buffer_triangle,buffer_normalize,buffer_reset,buffer_reverse,buffer_window,buffer_atan," +
      "buffer_clip,buffer_mul,buffer_div,buffer_rdiv,buffer_add,buffer_sub,buffer_rsub,delay," +
      "delay_write,delay_read,delay_fread,delay_sread,delay_fsread,delay_read2,delay_fread2,delay_sread2," +
      "delay_fsread2,delay_read3,delay_fread3,delay_sread3,delay_fsread3,sdelay,sdelay_write,sdelay_set_xfade," +
      "sdelay_read,sdelay_fread,sdelay_sread,sdelay_fsread,sdelay_read2,sdelay_fread2,sdelay_sread2,sdelay_fsread2," +
      "sdelay_read3,sdelay_fread3,sdelay_sread3,sdelay_fsread3,lop,lop_set_freq,lop_do,hip," +
      "hip_set_freq,hip_do,bp,bp_set_freq,bp_set_q,bp_do,butlp,butlp_set_freq," +
      ...
      "Pphasor_set_phase,Pphasor_reset,Pphasor_do,Plop,Plop_set_freq,Plop_do,Pgate,Pgate_set_thresh," +
      "Pgate_set_attack,Pgate_set_release,Pgate_set_lookahead,Pgate_do,Phip,Phip_set_freq,Phip_do,Pcompress," +
      "Pcompress_set_thresh,Pcompress_set_ratio,Pcompress_set_attack,Pcompress_set_release,Pcompress_set_lookahead,Pcompress_do,Pbp,Pbp_set_freq," +
      "Pbp_set_q,Pbp_do,Pbuthp,Pbuthp_set_freq,Pbuthp_do,Psine,Psine_set_freq,Psine_set_phase," +
      "Psine_reset,Psine_do,Pexpand,Pexpand_set_upthresh,Pexpand_do,Pexpand_set_ratio,Pexpand_set_attack,Pexpand_set_release," +
      "Pexpand_set_lookahead,Pharmon,Pharmon_set_transpo,Pharmon_set_feedback,Pharmon_set_winsize,Pharmon_do,Pwgverb,Pwgverb_set_feed," +
      "Pwgverb_set_cutoff,Pwgverb_set_bal,Pwgverb_do,Pbiquad,Pbiquad_set_freq,Pbiquad_set_q,Pbiquad_set_type,Pbiquad_do," +
